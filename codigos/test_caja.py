#!/usr/bin/env python3
"""
@file cajas_ejemplo.py
@author Equipo de desarrollo - Robotics 4.0
@date 2025-11-19
@brief Control de brazos del G1 utilizando SDK2 (sin locomoción) en Mujoco.
"""
    ...
    def __init__(self, interface, id):
        ...
        self.pasos = [
            ...
            ("Paso 2 (abrir para agarrar)", {
                ...
                G1JointIndex.LeftShoulderRoll: 0.65,
                ...
                G1JointIndex.WaistYaw: 0.0,
                G1JointIndex.WaistRoll: 0.0,
                G1JointIndex.WaistPitch: 0.5
            }),

            ("Paso 3 (agarre)", {
                # Acercar brazos
                G1JointIndex.LeftShoulderPitch: -0.99,   # mano baja hacia el cubo
                G1JointIndex.LeftShoulderRoll: -0.1,
                G1JointIndex.LeftShoulderYaw: -0.10,
                G1JointIndex.LeftElbow: 0.9,           # flexionar para bajar mano
                
                # Alinear muñeca con el cubo
                G1JointIndex.LeftWristPitch: -0.20,      # palma mirando hacia abajo
                G1JointIndex.LeftWristYaw: 0.33,
                G1JointIndex.LeftWristRoll: 0.0,

                # Brazo derecho igual
                G1JointIndex.RightShoulderPitch: -0.99,
                G1JointIndex.RightShoulderRoll: 0.01,
                G1JointIndex.RightShoulderYaw: 0.10,
                G1JointIndex.RightElbow: 0.9,

                G1JointIndex.RightWristPitch: -0.20,
                G1JointIndex.RightWristYaw: -0.33,
                G1JointIndex.RightWristRoll: 0.0,

                # Cintura estable
                G1JointIndex.WaistYaw: 0.0,
                G1JointIndex.WaistRoll: 0.0,
                G1JointIndex.WaistPitch: 0.52
            }),
